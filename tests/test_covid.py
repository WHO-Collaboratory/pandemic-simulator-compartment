...
and end-to-end runs for every COVID variant.

Run:
    python3 -m pytest tests/test_covid.py -v -m integration
    python3 -m pytest tests/test_covid.py -v  # unit tests only (no -m filter needed)
"""
