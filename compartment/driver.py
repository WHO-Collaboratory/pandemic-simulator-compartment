...
def drive_simulation(model_class: Model, args: dict):
    ...
    if args["mode"] == "local":
        ...
        simulation_params = {
            ...
            "GRAPHQL_ENDPOINT": "https://4dwku2cfqfcl3egnfx45y3b3a4.appsync-api.us-east-1.amazonaws.com/graphql",
            "GRAPHQL_APIKEY": "da2-pxtolh3slnaalmzn4ouvw7ykeq",
            "ENVIRONMENT": "uat"
        }
        run_metadata = run_simulation(
            model_class=model_class, mode="cloud", simulation_params=simulation_params
        )
    else:
