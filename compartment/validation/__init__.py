...
from .monkeypox_simulation_config import MonkeypoxSimulationConfig
from .monkeypox_disease import MonkeypoxDiseaseConfig
import logging
import sys
...
__all__ = [
    ...
    "MonkeypoxSimulationConfig",
    "MonkeypoxDiseaseConfig",
    "log_pydantic_errors",
...
def load_simulation_config(config: dict, disease_type: str):
    ...
    if disease_type == "VECTOR_BORNE":
        ...
        model_cls = MonkeypoxSimulationConfig
    else:
