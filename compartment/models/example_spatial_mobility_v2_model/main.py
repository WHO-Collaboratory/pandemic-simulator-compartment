...
def lambda_handler(event, context):
    drive_simulation(
        model_class=ExampleSpatialMobilityModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Example Disease with selectable spatial mobility simulation with specified config file"
    )
    ...
    drive_simulation(model_class=ExampleSpatialMobilityModel, args=vars(args))
