...
from compartment.models.ebola_test_model.model import EbolaTestModel
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Ebola (SEIHFR, Community/Hospital/Burial) — Legrand 2007 [test] simulation with specified config file"
    )
    ...
    drive_simulation(model_class=EbolaTestModel, args=vars(args))
