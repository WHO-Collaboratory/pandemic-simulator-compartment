...
from compartment.models.hantavirus_jax_model.model import HantavirusJaxModel
...
def lambda_handler(event, context):
    drive_simulation(
        model_class=HantavirusJaxModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run hantavirus simulation with specified config file"
    )
    ...
    drive_simulation(model_class=HantavirusJaxModel, args=vars(args))
