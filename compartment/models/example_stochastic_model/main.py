...
from compartment.models.example_stochastic_model.model import ExampleStochasticModel
...
def lambda_handler(event, context):
    drive_simulation(
        model_class=ExampleStochasticModel,
...
if __name__ == "__main__":
    ...
    drive_simulation(model_class=ExampleStochasticModel, args=vars(args))
