...
from compartment.models.ebola_importation_model.model import EbolaSEI1I2RDModel
...
def lambda_handler(event, context):
    drive_simulation(
        model_class=EbolaSEI1I2RDModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run ECDC Ebola SEI1I2RD simulation with specified config file"
    )
    ...
    drive_simulation(model_class=EbolaSEI1I2RDModel, args=vars(args))
