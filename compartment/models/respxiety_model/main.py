...
from compartment.models.respxiety_model.model import RespxietyModel
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run respXiety simulation with specified config file"
    )
    ...
    drive_simulation(model_class=RespxietyModel, args=vars(args))
