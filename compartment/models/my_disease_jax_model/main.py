...
from compartment.models.my_disease_jax_model.model import MyDiseaseJaxModel
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run My Disease simulation with specified config file"
    )
    ...
    drive_simulation(model_class=MyDiseaseJaxModel, args=vars(args))
