...
if __name__ == "__main__":
    ...
    if args.mode == 'local':
        ...
        if args.output_file:
            ...
            output_file = None
        run_metadata = run_simulation(model_class=CovidJaxModel, config_path=args.config_file, output_path=output_file)
        ...
        run_metadata = run_simulation(model_class=CovidJaxModel, mode='cloud', simulation_params=simulation_params)
    else:
