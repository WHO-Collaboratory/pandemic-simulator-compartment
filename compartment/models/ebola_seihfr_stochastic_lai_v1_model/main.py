...
from compartment.models.ebola_seihfr_stochastic_lai_v1_model.model import EbolaTestStochasticModel
...
def lambda_handler(event, context):
    drive_simulation(
        model_class=EbolaTestStochasticModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Ebola (SEIHFR, Community/Hospital/Burial) — Legrand 2007 [stochastic] simulation with specified config file"
    )
    ...
    drive_simulation(model_class=EbolaTestStochasticModel, args=vars(args))
