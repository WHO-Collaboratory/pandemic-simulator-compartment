...
class ExampleDiseaseStochasticModel(Model):
    """A simple SIR compartmental model for Example Disease with Stochasticity."""

    @classmethod
    def define_parameters(cls, schema):
        schema.set_model_info(
            disease_type="example_disease_stochastic",
