...
from compartment.models.example_disease_stochastic_model.model import ExampleDiseaseStochasticModel
...
def lambda_handler(event, context):
    drive_simulation(
        model_class=ExampleDiseaseStochasticModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Example Disease with Stochasticity simulation with specified config file"
    )
    ...
    drive_simulation(model_class=ExampleDiseaseStochasticModel, args=vars(args))
