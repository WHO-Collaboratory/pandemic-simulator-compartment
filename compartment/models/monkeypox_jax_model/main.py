...
from compartment.models.monkeypox_jax_model.model import MonkeypoxJaxModel
...
if __name__ == "__main__":
    ...
    drive_simulation(model_class=MonkeypoxJaxModel, args=vars(args))
