...
def lambda_handler(event, context):
    drive_simulation(
        model_class=ExampleDiseaseParameterUncertaintyModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Example Disease with Parameter Uncertainty simulation with specified config file"
    )
    ...
    drive_simulation(model_class=ExampleDiseaseParameterUncertaintyModel, args=vars(args))
