...
from compartment.models.ebola_seihfr_burial_legrand_model.model import EbolaSeihfrBurialLegrandModel
...
def lambda_handler(event, context):
    drive_simulation(
        model_class=EbolaSeihfrBurialLegrandModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Ebola (SEIHFR, Community/Hospital/Burial) — Legrand et al. 2007 simulation with specified config file"
    )
    ...
    drive_simulation(model_class=EbolaSeihfrBurialLegrandModel, args=vars(args))
