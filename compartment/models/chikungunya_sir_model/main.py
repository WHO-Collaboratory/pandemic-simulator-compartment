...
from compartment.models.chikungunya_sir_model.model import ChikungunyaSirModel
...
def lambda_handler(event, context):
    drive_simulation(
        model_class=ChikungunyaSirModel,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Chikungunya SIR Model simulation with specified config file"
    )
    ...
    drive_simulation(model_class=ChikungunyaSirModel, args=vars(args))
