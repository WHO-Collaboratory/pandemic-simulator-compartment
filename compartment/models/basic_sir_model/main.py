...
from compartment.models.basic_sir_model.model import ExampleSirModel
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Example SIR simulation with specified config file"
    )
    ...
    drive_simulation(model_class=ExampleSirModel, args=vars(args))
