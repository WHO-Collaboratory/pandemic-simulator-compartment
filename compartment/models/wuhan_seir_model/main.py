...
from compartment.models.wuhan_seir_model.model import SEIcIscRModel
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Wuhan SEIcIscR simulation with specified config file"
    )
    ...
    drive_simulation(model_class=SEIcIscRModel, args=vars(args))
